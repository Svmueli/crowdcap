// src/pages/signup/SmeSignup.tsx
import React from 'react';

const SmeSignup: React.FC = () => {
  return (
    <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg mx-auto mt-24">
      <h2 className="text-4xl font-bold mb-6 text-gray-800">Register as an SME</h2>

      <form className="space-y-5">
        <div>
          <label className="block text-gray-600 text-sm font-semibold mb-2">Business Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-gray-600 text-sm font-semibold mb-2">Re-type Password</label>
          <input
            type="password"
